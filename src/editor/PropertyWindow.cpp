...
template<typename T> void PropertyWindow::DrawComponent(const char* name, T& component) {
...
template<typename T> void PropertyWindow::DrawProperty(const char* name, T& val) {
    // 1st column
