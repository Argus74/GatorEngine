...
LuaState::LuaState(std::string lua_state_file, std::shared_ptr<Entity> attached_entity) {
    ...
    lua_.open_libraries(sol::lib::base, sol::lib::package, sol::lib::string, sol::lib::os,
                        sol::lib::math, sol::lib::table, sol::lib::debug, sol::lib::io,
                        sol::lib::jit);
    ...
    sol::usertype<Vec2> vec2 =
        lua_.new_usertype<Vec2>("Vec2", sol::constructors<Vec2(), Vec2(float, float)>());
    vec2["X"] = &Vec2::x;
    vec2["Y"] = &Vec2::y;
    ...
    cHealth["CurrentHealth"] = &CHealth::current_health;
    cHealth["HealthTotal"] = &CHealth::health_total;
    cHealth["DrawHealth"] = &CHealth::draw_health;
    cHealth["FollowEntity"] = &CHealth::follow_entity;
    cHealth["RespawnCharacter"] = &CHealth::respawn_character;
    cHealth["RespawnPosition"] = &CHealth::respawn_position;
    ...
    entity["GetCName"] =
        static_cast<std::shared_ptr<CName>& (Entity::*)()>(&Entity::getComponent<CName>);
    entity["GetCInformation"] = static_cast<std::shared_ptr<CInformation>& (Entity::*)()>(
        &Entity::getComponent<CInformation>);
    entity["GetCTransform"] =
        static_cast<std::shared_ptr<CTransform>& (Entity::*)()>(&Entity::getComponent<CTransform>);
    ...
    sol::usertype<EntityManager> entity_manager =
